...
12. Once the packages have been published to NPM, create a PR for the following repositories that updates the dependency versions:
    - [vets-website](https://github.com/department-of-veterans-affairs/vets-website)
      ...
      - **Important**: Run all vets-website tests to ensure compatibility with existing code. This can be done by running the [Full Suite Tests](https://github.com/department-of-veterans-affairs/vets-website/actions/workflows/full-suite-tests.yml) workflow on your release branch. Select both the "Run the full unit test suite"  and "Run the full E2E test suite" options.
