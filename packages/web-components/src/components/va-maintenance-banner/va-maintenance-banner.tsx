...
@Component({
  ...
  styleUrl: 'va-maintenance-banner.css',
  shadow: true,
})
export class VaMaintenanceBanner {
  ...
  /**
   * The type of the banner. One of 'error', or 'warning'. This affects both the icon of the AlertBox and the top border color.
   * */
  @Prop() type: string = 'warning';
