            ...
            <fieldset class="usa-fieldset usa-form">
              ...
              <div class="usa-memorable-date">
                ...
                <div class="usa-form-group usa-form-group--day">
                  <va-text-input aria-describedby="dateHint" class="hydrated memorable-date-input usa-form-group--day-input" show-input-error=""></va-text-input>
                </div>
                <div class="usa-form-group usa-form-group--year">
                  <va-text-input aria-describedby="dateHint" class="hydrated memorable-date-input usa-form-group--year-input" show-input-error="" value=""></va-text-input>
                </div>
              </div>
            </fieldset>
          </div>
        ...
        <div class="input-wrap">
          <fieldset class="usa-fieldset usa-form">
            ...
            <div class="usa-memorable-date">
              ...
              <div class="usa-form-group usa-form-group--day">
                <va-text-input aria-describedby="dateHint hint" class="hydrated memorable-date-input usa-form-group--day-input" show-input-error=""></va-text-input>
              </div>
              <div class="usa-form-group usa-form-group--year">
                <va-text-input aria-describedby="dateHint hint" class="hydrated memorable-date-input usa-form-group--year-input" show-input-error="" value=""></va-text-input>
              </div>
            </div>
          </fieldset>
        </div>
            ...
            <fieldset class="usa-fieldset usa-form">
              ...
              <div class="usa-memorable-date">
                <div class="usa-form-group usa-form-group--month">
                  <va-text-input aria-describedby="dateHint" class="hydrated memorable-date-input usa-form-group--month-input" show-input-error=""></va-text-input>
                </div>
                <div class="usa-form-group usa-form-group--day">
                  <va-text-input aria-describedby="dateHint" class="hydrated memorable-date-input usa-form-group--day-input" show-input-error=""></va-text-input>
                </div>
      ...
      <mock:shadow-root>
        <div class="input-wrap">
          <fieldset class="usa-fieldset usa-form">
            ...
            <div class="usa-memorable-date">
              <div class="usa-form-group usa-form-group--month">
                <va-text-input aria-describedby="dateHint hint" class="hydrated memorable-date-input usa-form-group--month-input" show-input-error=""></va-text-input>
              </div>
              <div class="usa-form-group usa-form-group--day">
                <va-text-input aria-describedby="dateHint hint" class="hydrated memorable-date-input usa-form-group--day-input" show-input-error=""></va-text-input>
              </div>
