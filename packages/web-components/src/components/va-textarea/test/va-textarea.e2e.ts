...
describe('va-textarea', () => {
  it('textarea component renders', async () => {
  ...
  it('textarea component renders an error message', async () => {
    const page = await newE2EPage();
  ...
  it('textarea component adds new aria-describedby for error message', async () => {
    const page = await newE2EPage();
    await page.setContent('<va-textarea error="This is a mistake" />');
  ...
  it('textarea component renders a required span', async () => {
    const page = await newE2EPage();
  ...
  it('textarea component fires an analytics event when enableAnalytics is true', async () => {
    const page = await newE2EPage();
  ...
  it('textarea component does not fire an analytics event when enableAnalytics is not truthy', async () => {
    const page = await newE2EPage();
  ...
  it('textarea component demits blur event', async () => {
    const page = await newE2EPage();
  ...
  it('textarea component emits input event with value updated', async () => {
    const page = await newE2EPage();
  ...
  it('textarea component adds a max character limit with descriptive text', async () => {
    const page = await newE2EPage();
  ...
  it('textarea component ignores negative maxlength values', async () => {
    const page = await newE2EPage();
  ...
  it('textarea component ignores a maxlength of zero', async () => {
    const page = await newE2EPage();
  ...
  it('textarea component shows chars allowed on load if maxlength and charcount set', async () => {
    const page = await newE2EPage();
    await page.setContent(
  ...
  it('textarea component shows chars left if maxlength set', async () => {
    const page = await newE2EPage();
  ...
  it('textarea component shows chars over limit as error and sets aria-invalid attribute', async () => {
    const page = await newE2EPage();
  ...
  it('textarea component useFormsPattern displays header for the multiple field pattern', async () => {
    const page = await newE2EPage();
    await page.setContent(
  ...
  it('textarea component useFormsPattern does not display header if "single" or "multiple" is not indicated', async () => {
    const page = await newE2EPage();
    await page.setContent(
  ...
  it('textarea component useFormsPattern passes an aXe check', async () => {
    const page = await newE2EPage();
