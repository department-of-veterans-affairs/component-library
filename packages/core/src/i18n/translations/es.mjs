export default {
  ...
  'expand-all-aria-label-section-heading': 'Expandir todos los acordeones de {{sectionHeading}}',
  'collapse-all-aria-label': 'Contraer todos los acordeones',
  'collapse-all-aria-label-section-heading': 'Contraer todos los acordeones de {{sectionHeading}}',
  'january': 'Enero',
  'february': 'Febrero',
  'march': 'Marzo',
  'april': 'Abril',
