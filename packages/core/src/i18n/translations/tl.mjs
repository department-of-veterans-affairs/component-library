export default {
  ...
  'expand-all-aria-label-section-heading': 'I-expand ang lahat ng accordion, {{sectionHeading}}',
  'collapse-all-aria-label': 'I-collapse ang lahat ng accordion',
  'collapse-all-aria-label-section-heading': 'I-collapse ang lahat ng accordion, {{sectionHeading}}',
