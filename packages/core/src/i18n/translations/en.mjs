export default {
  ...
  'expand-all-aria-label-section-heading': 'Expand all accordions of {{sectionHeading}}',
  'collapse-all-aria-label': 'Collapse all accordions',
  'collapse-all-aria-label-section-heading': 'Collapse all accordions of {{sectionHeading}}',
  'january': 'January',
  'february': 'February',
  'march': 'March',
  'april': 'April',
