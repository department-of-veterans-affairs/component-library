export default {
  ...
  'expand-all-aria-label-section-heading': 'Expand all accordions, {{sectionHeading}}',
  'collapse-all-aria-label': 'Collapse all accordions',
  'collapse-all-aria-label-section-heading': 'Collapse all accordions, {{sectionHeading}}',
  'january': 'January',
  'february': 'February',
  'march': 'March',
  'april': 'April',
