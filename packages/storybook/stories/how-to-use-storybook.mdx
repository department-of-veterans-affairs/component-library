...
<img src={canvasZoomImage} alt="A screenshot of the zoom controls in the Canvas tab" />
...
<img src={canvasToggleBackgroundImage} alt="A screenshot of the background toggle tool" />
...
<img src={canvasViewportImage} alt="A screenshot of the viewport size and orientation tool" />

The **measure tool** allows you to hover over an element and view information about its height, width, padding and margin.

<img src={canvasMeasureImage} alt="A screenshot of the measure tool in the Canvas tab" />

The **outline tool** applies outlines to elements in the component.

<img src={canvasOutlineImage} alt="A screenshot of the outline tool in the Canvas tab" />

The **color filter tool** simulates how the component looks for users with vision impairments.

<img src={canvasVisionImage} alt="A screenshot of the color filter tool in the Canvas tab" />
...
<img src={canvasOtherImage} alt="A screenshot of the other tools in the Canvas tab" />
...
<img src={canvasAddonsImage} alt="A screenshot showing Storybook's menu and addon options selected" />
...
<img src={canvasControlsImage} alt="A screenshot of the Controls addon in the Canvas tab" />
...
<img src={canvasStoryImage} alt="A screenshot of the Story addon in the Canvas tab" />
...
<img src={canvasHtmlImage} alt="A screenshot of the HTML addon in the Canvas tab" />
...
<img src={canvasAccessibilityImage} alt="A screenshot of the Accessibility addon in the Canvas tab" />
