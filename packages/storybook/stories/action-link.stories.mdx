...
<Meta title="Components/Action link/CSS Component/Action link" id="Components/Action link" />

<Title>Action link</Title>
<Subtitle>Action link component</Subtitle>
<MaturityScale
  category={additionalDocs['Action link'].maturityCategory}
  level={additionalDocs['Action link'].maturityLevel}
/>
<Guidance
  href={additionalDocs['Action link'].guidanceHref}
  name={additionalDocs['Action link'].guidanceName}
/>
