...
const WithRouterTemplate = ({ href: href, text: text }) => {
  return (
    <>
      <p>
        The <code>va-link</code> web component can be used with a routing
        framework like react-router using the native <code>click</code> event
      ...
      <pre className="vads-u-font-size--sm vads-u-background-color--gray-lightest vads-u-padding--2">
        <code>
          ...
          <br />
          <br />
          const YourComponent &#61; (&#x7b; href, text, router &#x7d;)
          &#61;&#62; &#x7b;
          <br />
          <br />
